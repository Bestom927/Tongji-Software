...
function LecturePhotoPlayer(){
  const [photoList] = useState([
    'https://static.igem.wiki/teams/4272/wiki/education-lecture3.png',
    'https://static.igem.wiki/teams/4272/wiki/education-lecture4.png',
    'https://static.igem.wiki/teams/4272/wiki/education-lecture5.png',
  ]);
  return (
    <Carousel
      autoplay
    ...
    >
      {photoList.map(val => (
        <img
          ...
          src={val}
          alt=""
          style={{ width: '100%', verticalAlign: 'right' ,height:""}}
        />
      ))}
    </Carousel>
  )
    ...
    return(
      <div className='edu-page-box'>
          <div className='communication'>
            ...
            <div id='communication-title'>Communication</div>

            <div className="edu-Img" id="education-picture1" style={{paddingLeft:"81vw",top:"75vh"}}> <img src="https://static.igem.wiki/teams/4272/wiki/education1.png" alt="education1.png" /></div>
            <div className="edu-Img" id="education-picture2" style={{paddingLeft:"76vw",top:"85vh"}}> <img src="https://static.igem.wiki/teams/4272/wiki/education2.png" alt="education2.png" /></div>
            ...
            <div className="edu-Img" id="education-picture3" style={{paddingLeft:"70vw",top:"108vh"}}> <img src="https://static.igem.wiki/teams/4272/wiki/education3.png" alt="education3.png" /></div>
            <div className="edu-Img" id="education-picture4" style={{paddingLeft:"76vw",top:"125vh"}}> <img src="https://static.igem.wiki/teams/4272/wiki/education4.png" alt="education4.png" /></div>
            <div className="edu-Img" id="education-picture5" style={{paddingLeft:"20vw",top:"154vh"}}> <img src="https://static.igem.wiki/teams/4272/wiki/education5.png" alt="education5.png" /></div>
            <div className="edu-Img" id="education-picture6" style={{paddingLeft:"66vw",top:"157vh"}}> <img src="https://static.igem.wiki/teams/4272/wiki/education6.png" alt="education6.png" /></div>
            <div className="edu-Img" id="education-picture7" style={{paddingLeft:"74vw",top:"170vh"}}> <img src="https://static.igem.wiki/teams/4272/wiki/education7.png" alt="education7.png" /></div>
