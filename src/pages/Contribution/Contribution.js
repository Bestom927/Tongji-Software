...
<p style={{width:"75vw",marginLeft:"8vw"}}>
To further enhance advocacy efforts for the igme community, we participated in the advocacy exchange, CCIC, held by numerous igemer within China and collaborated to prepare the CRISPR Handbook. The manual includes an introduction to CRISPR and ideas for topic selection from previous iGEM teams with the hope of informing future igemers.
</p>
<p style={{width:"75vw",marginLeft:"8vw"}}>
