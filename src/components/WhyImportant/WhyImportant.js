...
const WhyImportant = () => {
    ...
    <br/>
         ...
         <br/><br/>
        <p>
        In <span style={{color:"#2e77e5",fontSize:"x-large",fontWeight:"bolder"}}>2017</span>, Korean scientist Jin-Soo Kim demonstrated the off-target effect of </p>
        <p>
        ...
        <p>
        In <span style={{color:"#2e77e5",fontSize:"x-large",fontWeight:"bolder"}}>2019</span>, Chinese scientist Yang Hui published a new method to detect 
        </p>
        <p>
        ...
        In <span style={{color:"#2e77e5",fontSize:"x-large",fontWeight:"bolder"}}>2020</span>, it was found that other sequences in the genome may also be cleaved nonspecifically by <p></p>
        ...
        <p></p>
        In <span style={{color:"#2e77e5",fontSize:"x-large",fontWeight:"bolder"}}>2022</span>, Study results indicate that in addition to considering off-target effects caused by base mismatches, <p></p>
